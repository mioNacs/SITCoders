...
import { updateTextDetails } from "../../services/api";
...
const ProfileHeader = ({showDialog}) => {
  ...
  const handleSave = async () => {
    ...
    setLoading(true);
    try{
        const response = await updateTextDetails({
    ...
    <div className="relative w-full bg-gradient-to-r from-orange-400 to-orange-500 h-48 rounded-t-lg">
      {!isEditing ? (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className=" bg-white bg-opacity-95 rounded-lg p-4 shadow-lg sm:w-md md:w-lg">
