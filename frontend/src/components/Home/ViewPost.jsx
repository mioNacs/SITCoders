    ...
    try {
      ...
      if (result.success) {
        ...
        setComments(prev => {
          ...
          const commentIndex = updatedComments.findIndex(c => c._id === replyTo);
          if (commentIndex !== -1) {
            updatedComments[commentIndex] = {
              ...updatedComments[commentIndex],
              replies: [...(updatedComments[commentIndex].replies || []), result.reply]
            };
          }
          return {
            ...prev,
                          ...
                          <div key={reply._id} className="bg-gray-50 rounded p-3">
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <h6 className="font-medium text-gray-800 text-sm">
                                {reply.author?.fullName || reply.author?.username || "Unknown User"}
                              </h6>
